...
const mobile = [
  ...
  {
    id: 2,
    name: "Learning System Application",
    description: "Learning Mobile Aplication.",
  },
  {
    id: 3,
    name: "Restaurant Apps",
    description: "food Aplication",
  },
  {
    id: 4,
    name: "Social Media Apps",
    description: "Best And Secure Social Apps",
  },
  {
    id: 5,
    name: "Clone Application",
    description: "Populer Aplication Clones.",
  },
];
...
function SingleCategory(props) {
  ...
  return (
    ...
    <div className="pb-8 md:pb-20 h-fit px-2 md:px-12 md:mx-24">
			<div className='flex flex-col gap-2 pt-2 md:mt-4 mb-7 pl-4'>
      <nav aria-label="Breadcrumb">
        <ol role="list" className="flex items-center gap-1 text-sm text-gray-600">
          ...
          <li>
            <Link href="/apps" className="block transition hover:text-gray-700"><span>Apps</span></Link>
          </li>
          ...
          <li>
			...
			<div className="ml-4 bg-white rounded flex gap-2 items-center w-full md:w-1/3 p-3 shadow-sm border border-gray-200">
				<input
...
export async function getServerSideProps({ query }) {
  ...
  return {
    props: {
      project: mobile.filter((project) => project.id === parseInt(id))[0],
    },
  };
}

...
import {CodeSyntax} from 'data/codesyntax';
...
function SingleComponent(props){
  ...
  return (
    ...
    {filteredComponents.map( (item, index ) =>
      ...
      <Tab.Group>
        <Tab.List className="relative flex gap-1 space-x-1 rounded-xl p-1 flex rounded-md p-1 transition">
          ...
          classNames(
            ...
            'focus:outline-none',
            selected
              ? 'bg-transparent text-black dark:text-white shadow-lg'
              : 'text-gray-600 dark:text-gray-400'
          )
              }>html</Tab>
          <Tab className={({ selected }) =>
          classNames(
           ...
           <button onClick={() => setTheme('light')} className="inline-flex items-center justify-center gap-2 rounded-md border bg-transparent py-2.5 px-3 align-middle text-xs font-medium text-gray-700 shadow-sm transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus-visible:ring-gray-700 dark:focus-visible:ring-offset-gray-800">
              <span className="group inline-flex h-4 w-4 flex-shrink-0 items-center justify-center font-medium text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-gray-500">
                <svg className="hidden h-3 w-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
           ...
           <a
              className="js-clipboard group inline-flex items-center justify-center gap-2 rounded-md border py-2.5 px-3 align-middle text-xs font-medium text-gray-700 shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-gray-700 dark:focus:ring-offset-gray-800"
              href="javascript:;"
        ...
        <Tab.Panels className="mt-3">
          <Tab.Panel className={classNames(
              ...
              <div className="h-40 min-h-full flex justify-center items-center">{item.component}</div>
              </ThemeProvider>
              </Tab.Panel>
          <Tab.Panel className={classNames(
              ...
              <SyntaxHighlighter customStyle={{borderRadius: "10px", backgroundColor: "white"}} language="html" style={CodeSyntax}>
                {item.code}
              </SyntaxHighlighter>
              </Tab.Panel>
          <Tab.Panel className={classNames(
              ...
              <SyntaxHighlighter customStyle={{borderRadius: "10px", backgroundColor: "white", textShadow: "none", fontSize: "10"}} style={CodeSyntax} language="javascript">
                {item.code}
              </SyntaxHighlighter>
              </Tab.Panel>
        </Tab.Panels>

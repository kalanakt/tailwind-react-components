...
import tailwindcssLogoMark from '@/img/brand/tailwindcss-mark'
import tailwindcssLogoType from '@/img/brand/tailwindcss-logotype'
import tailwindcssLogoTypeWhite from '@/img/brand/tailwindcss-logotype-white'

...
<select
  id="countries"
  class="bg-gray-100 text-gray-700 dark:text-gray-300 dark:bg-slate-900 bg-opacity-20 w-fit py-1 px-3 border border-gray-300 text-sm rounded-lg focus:outline-none"
>
  <option selected class="text-gray-700 dark:text-gray-300 hover:bg-green-300">React js</option>

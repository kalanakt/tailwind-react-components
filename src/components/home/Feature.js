      ...
      <div className="container grid max-w-screen-xl gap-8 lg:grid-cols-2 lg:grid-rows-2">
        <div className="row-span-2 shadow-md flex flex-col rounded-md border border-slate-200 dark:border-slate-900">
          ...
          <div className="p-10">
            ...
            <p className="mt-2 text-slate-500">
              ...
              live-chat, Facebook, Twitter, WhatsApp, Instagram, Line, etc., and helps you deliver a
              consistent customer experience across channels.
            </p>
            <p className="mt-2 inline-flex text-sky-700">
        ...
        <div className="flex shadow-md rounded-md border border-slate-200 dark:border-slate-900">
          <div className="flex-1 p-10">
            ...
            <p className="mt-2 text-slate-500">
              Connect with your website visitors, communicate with them in realtime and give them
              quality support with a live-chat widget that fits your brand.
            </p>
            <p className="mt-2 inline-flex text-sky-700">
              <Link href="">Read More →</Link>
            </p>
          ...
          <div className="rounded-r-md relative hidden h-full w-2/5 overflow-hidden lg:block">
            <div className="absolute">
              <Image
                ...
                height={1000}
                src="/img/card-top.jpg"
                className="border-r object-cover object-left-top"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="flex shadow-md flex-row rounded-md border border-slate-200 dark:border-slate-900">
          <div className="flex-1 p-10">
            ...
            <p className="mt-2 text-slate-500">
              Integrate with chatbots using Rasa or Dialogflow to automate conversations. Qualify
              using chatbots and seamlessly handoff to human agents.
            </p>
            <p className="mt-2 inline-flex text-sky-700">
              <Link href="">Read More →</Link>
            </p>

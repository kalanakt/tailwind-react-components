...
function DocSidebar(props) {
  return (
    <div className="h-full p-3 space-y-2">
    	<div className="flex items-center p-2 space-x-4 w-f">
      ...
      {components.map((item) => (
        <div key={item.id}>
          <h5 className="pt-4 font-semibold text-slate-900 dark:text-slate-200 lg:mb-3">{item.name}</h5>
          ...
          {item.subcategory.map((component, index) => (
              ...
              >
              <p className="-ml-px block border-l border-transparent pl-4 text-slate-700 hover:border-slate-400 hover:text-slate-900 dark:text-slate-400 dark:hover:border-slate-500 dark:hover:text-slate-300">{component.name}</p>
              </Link>
              </li>
            ))}
          </ul>

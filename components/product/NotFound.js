...
export default function NotFound() {
	...
	return (
		<div className="h-full bg-transparent flex flex-col justify-center items-center">
			<div className="m-auto mt-8 flex flex-col justify-center items-center">
				<svg
				...
				<div className="mt-4 tracking-widest flex flex-col justify-center items-center">
			...
			<div className="pt-6 flex flex-row justify-center gap-4">
				<div className="rounded-md border border-gray-500 h-fit w-fit px-3 py-2 font-mono text-xl text-gray-500 hover:shadow-md hover:text-gray-800 dark:hover:text-white">
					<button type="button" onClick={refresh}>Go back</button>
				</div>
				<div className="rounded-md border border-gray-500 h-fit w-fit px-3 py-2 font-mono text-xl text-gray-500 hover:shadow-md hover:text-gray-800 dark:hover:text-white">
